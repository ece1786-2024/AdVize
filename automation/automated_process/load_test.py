...
#     try:
#         print("Start running the docker container...\n")
...
#     docker_image = input("Enter the Docker image name for the ad-pushing algorithm: ")
...
#     # commercial_ads_data = pd.read_csv(ads_data_path, sep=',', on_bad_lines='skip', header=None)
...
#                 # get ad content from docker
#                 # ad_content = get_ad_content_from_docker(docker_url, query, commercial_ads_data)
    ...
    while True:
        ...
        while True:
            next_action = input("\nWhat would you like to do next?\n"
                                "1. Load another Docker image and run simulation.\n"
                                "2. View results from different algorithms (graph).\n"
                                "3. Exit.\n"
